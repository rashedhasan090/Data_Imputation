...
Original file is located at
    https://colab.research.google.com/drive/1LUpy3rq4EPG-NXL_fJAhkGCJBRqWhG1H
"""
...
# Parameters
param_grid_knn = {'iterativeimputer__n_nearest_features': [1, 3, 5], 'iterativeimputer__estimator__n_neighbors':  [2, 5, 10, 20],
                 'iterativeimputer__estimator__weights': ['uniform','distance'],'iterativeimputer__estimator__p': [1, 2], 'iterativeimputer__estimator__leaf_size':[2, 5, 10, 20, 30, 40, 50]}
